...
# ===== NOTE: L2 PRIVACY/SECURITY METRICS MOVED =====
# All L2 Privacy/Security historical metrics, trends, and framework data
# have been moved to the dedicated Privacy & Security Hub (port 8502)
# Access via sidebar: 🔐 Privacy & Security Hub → 📈 L2 Historical Metrics
