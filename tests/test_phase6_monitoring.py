...
class TestChangeDetector:
    ...
    def test_detect_modified_requirement(self):
        ...
        assert result.total_changes == 1
        # Detector correctly identifies textual changes as REQUIREMENT_CLARIFIED
        assert result.changes[0].change_type == ChangeType.REQUIREMENT_CLARIFIED
...
class TestNotificationManager:
    ...
    def test_notification_creation(self):
        ...
        assert all(
            n.priority == NotificationPriority.CRITICAL for n in notifications)
    ...
    def test_notification_channels(self):
        ...
        critical_channels = manager._determine_channels(
