...
class TestTFIDFSearchEngine:
    ...
    def test_requirement_indexing(self):
        ...
        requirements = [
            {'requirement_id': 'REQ-1',
                'text': 'Implement access control', 'regulation': 'EU AI'},
            {'requirement_id': 'REQ-2',
                'text': 'Apply encryption', 'regulation': 'GDPR'},
        ]
    ...
    def test_search_retrieval(self):
        ...
        requirements = [
            ...
            {'requirement_id': 'REQ-3',
                'text': 'User access control', 'regulation': 'ISO'},
        ]
    ...
    def test_similarity_threshold(self):
        ...
        requirements = [
            ...
            {'requirement_id': 'REQ-2',
                'text': 'Implementation details', 'regulation': 'GDPR'},
        ]
